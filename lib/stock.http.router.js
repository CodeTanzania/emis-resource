 ...
 * @apiSuccess {Object} owner A party(i.e institution, organization etc)
 * owning item under stock.
 * @apiSuccess {Object} item An item under stock.
 ...
 * @apiSuccess {Object} data.owner A party(i.e institution, organization etc)
 * owning item under stock.
 * @apiSuccess {Object} data.item An item under stock.
...
/* declarations */
const Stock = require(path.join(__dirname, 'stock.model'));
