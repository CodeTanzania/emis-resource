...
const TYPES = getStrings('ITEM_TYPES', [
  'Equipment', 'Material',
  'Vehicle', 'Supply',
  'Service', DEFAULT_TYPE
]);


/* unit of measures */
const DEFAULT_UOM = 'unit';
const UOMS = getStrings('ITEM_UOMS', [
  'bag', 'box', 'carton',
  'drum', 'dozen', 'gallon',
  'kit', 'pallet', 'unit',
  'piece', 'bucket', 'bottle ',
...
const ItemSchema = new Schema({
   ...
   * @property {boolean} index - ensure database index
   * @property {boolean} unique - ensure database index
   ...
   * available i.e additional details that clarify what is an item(or resource).
   *
   * @type {object}
   * @property {object} type - schema(data) type
   * @property {boolean} trim - force trimming
