...
router.get(PATH_LIST, function getWarehouses(request, response, next) {
  ...
  Warehouse.get(options, function onGetWarehouses(error, results) {
    // forward error
    if (error) {
      next(error);
    }
...
router.post(PATH_LIST, function postWarehouse(request, response, next) {
  ...
  Warehouse.post(body, function onPostWarehouse(error, created) {
    // forward error
    if (error) {
      console.log(error);
      next(error);
...
router.get(PATH_SINGLE, function getWarehouse(request, response, next) {
  ...
  Warehouse.getById(options, function onGetWarehouse(error, found) {
    // forward error
    if (error) {
      next(error);
    }
...
router.patch(PATH_SINGLE, function patchWarehouse(request, response, next) {
  ...
  Warehouse.patch(_id, patches, function onPatchWarehouse(error, patched) {
    // forward error
    if (error) {
      next(error);
    }
...
router.put(PATH_SINGLE, function putWarehouse(request, response, next) {
  ...
  Warehouse.put(_id, updates, function onPutWarehouse(error, updated) {
    // forward error
    if (error) {
      next(error);
    }
...
router.delete(PATH_SINGLE, function deleteWarehouse(request, response, next) {
  ...
  Warehouse.patch(_id, patches, function onDeleteWarehouse(error, deleted) {
    //forward error
    if (error) {
      next(error);
    }
